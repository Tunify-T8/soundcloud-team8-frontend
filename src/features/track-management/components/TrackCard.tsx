...
//   return (
//     <div
//       className={`flex items-center gap-6 px-6 py-4 rounded transition-colors cursor-pointer
//         ${hovered ? "bg-zinc-800" : "bg-zinc-900"}
//         border border-transparent hover:border-zinc-700 group`}
...
//         className="w-5 h-5 rounded border-zinc-600 bg-zinc-800 accent-orange-500 flex-shrink-0"
//         onClick={(e) => e.stopPropagation()}
//       />

//       {/* Thumbnail + Play Button */}
//       <div className="relative w-14 h-14 flex-shrink-0 bg-zinc-700 rounded flex items-center justify-center group/thumb">
//         {track.thumbnailUrl ? (
...
//         <div className="absolute inset-0 bg-black/30 rounded opacity-0 group-hover/thumb:opacity-100 transition-opacity flex items-center justify-center">
//           <Play className="w-6 h-6 text-white fill-white" />
//         </div>
...
//           )}
//         </div>
//         <p className="text-zinc-400 text-xs truncate">{"Unknown Artist"}</p>
//       </div>

//       {/* Duration */}
//       <div className="w-14 text-center flex-shrink-0">
//         <span className="text-zinc-300 text-sm tabular-nums font-medium">{track.duration}</span>
//       </div>
...
//       {/* Engagements */}
//       <div className="flex items-center gap-6 w-64 justify-start flex-shrink-0">
//         <span className="flex items-center gap-1.5 text-zinc-400 text-sm hover:text-white transition-colors cursor-pointer">
//           <Heart className="w-4 h-4" />
//           <span className="tabular-nums">{fmt(track.engagements.likes)}</span>
//         </span>
//         <span className="flex items-center gap-1.5 text-zinc-400 text-sm hover:text-white transition-colors cursor-pointer">
//           <MessageSquare className="w-4 h-4" />
//           <span className="tabular-nums">{fmt(track.engagements.comments)}</span>
//         </span>
//         <span className="flex items-center gap-1.5 text-zinc-400 text-sm hover:text-white transition-colors cursor-pointer">
//           <Repeat2 className="w-4 h-4" />
//           <span className="tabular-nums">{fmt(track.engagements.reposts)}</span>
//         </span>
//         <span className="flex items-center gap-1.5 text-zinc-400 text-sm hover:text-white transition-colors cursor-pointer">
//           <Download className="w-4 h-4" />
//           <span className="tabular-nums">{fmt(track.engagements.downloads)}</span>
//         </span>
//       </div>

//       {/* Plays */}
//       <div className="w-12 text-right flex-shrink-0">
//         <span className="text-white text-sm font-semibold tabular-nums">{track.engagements.plays}</span>
//       </div>

//       {/* More menu */}
//       <button
//         className="p-2 rounded hover:bg-zinc-700 text-zinc-400 hover:text-white transition-colors flex-shrink-0 opacity-0 group-hover:opacity-100"
//         onClick={(e) => e.stopPropagation()}
//         title="More options"
//       >
