...
const ActionButtons = ({ isLiked, isReposted, isLoading, onLike, onRepost }: Props) => {
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className={`w-10 h-10 rounded flex items-center justify-center transition ${
          isLiked ? 'bg-zinc-700 text-orange-500' : 'bg-zinc-800 text-white hover:bg-zinc-700'
        }`}
      >
      ...
      <button
        ...
        disabled={isLoading}
        className={`w-10 h-10 rounded flex items-center justify-center transition ${
          isReposted ? 'bg-zinc-700 text-orange-500' : 'bg-zinc-800 text-white hover:bg-zinc-700'
        }`}
      >
