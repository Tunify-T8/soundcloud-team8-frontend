...
const USERS = {
  ...
  "user-uuid-3": {
    ...
    displayName: "Ava Mix",
    role: "ARTIST",
    bio: "DJ and mixer. Cairo underground scene.",
    location: "Cairo, Egypt",
  ...
  "user-uuid-4": {
    ...
    role: "ARTIST",
    bio: "Hip-hop producer from Cairo.",
    location: "Cairo, Egypt",
...
let tracks = [
  {
    ...
    waveformData: [
      12, 18, 22, 30, 27, 25, 33, 40, 38, 29, 21, 18, 14, 20, 26, 31, 28, 22,
      17, 24,
    ],
    duration: 214,
    ...
    isHD: true,
    isPrivate: false,
    thumbnailUrl: "https://picsum.photos/seed/trk001/300/300",
  ...
  },
  {
    ...
    waveformData: [
      8, 10, 14, 18, 16, 15, 20, 22, 19, 17, 13, 9, 11, 14, 17, 20, 18, 15, 12,
      10,
    ],
    duration: 176,
    ...
    isHD: false,
    isPrivate: true,
    thumbnailUrl: "https://picsum.photos/seed/trk002/300/300",
    userId: "mock-user-001",
  },
  {
    id: "trk_003",
    ...
    description:
      "Smooth synthwave vibes for late night drives through the city.",
    waveformData: [
      12, 18, 25, 30, 28, 22, 19, 24, 29, 26, 20, 15, 18, 23, 27, 32, 30, 25,
      21, 16,
    ],
    duration: 245,
    date: "2026-03-10T00:00:00.000Z",
    ...
    isHD: true,
    isPrivate: false,
    thumbnailUrl: "https://picsum.photos/seed/trk003/300/300",
    userId: "mock-user-001",
  },
  {
    id: "trk_004",
    ...
    waveformData: [
      6, 9, 15, 21, 24, 22, 18, 16, 19, 23, 17, 11, 13, 16, 20, 25, 22, 18, 14,
      10,
    ],
    duration: 312,
    ...
    isHD: true,
    isPrivate: true,
    thumbnailUrl: "https://picsum.photos/seed/trk004/300/300",
    userId: "mock-user-001",
  },
  {
    id: "trk_005",
    ...
    waveformData: [
      20, 25, 30, 35, 32, 28, 22, 26, 31, 27, 21, 18, 23, 28, 33, 36, 30, 24,
      19, 22,
    ],
    duration: 180,
    ...
    isHD: true,
    isPrivate: false,
    thumbnailUrl: "https://picsum.photos/seed/trk005/300/300",
    userId: "user-uuid-2",
  },
  {
    id: "trk_006",
    ...
    waveformData: [
      15, 20, 28, 33, 30, 24, 19, 22, 27, 25, 20, 16, 21, 26, 30, 34, 29, 23,
      18, 21,
    ],
    duration: 240,
    ...
    isHD: false,
    isPrivate: false,
    thumbnailUrl: "https://picsum.photos/seed/trk006/300/300",
    userId: "user-uuid-3",
  },
];
  ...
  "conv-uuid-1": [
    {
      ...
      type: "TEXT",
      text: "Hey! Want feedback on your latest mix?",
    ...
    },
    {
      ...
      type: "TEXT",
      text: "Yes please, send your notes.",
      createdAt: "2026-03-14T16:08:00.000Z",
      status: "READ",
    },
    {
      id: "msg-1-3",
  ...
  "conv-uuid-2": [
    {
      ...
      receiverId: "mock-user-001",
      type: "TEXT",
      text: "Hey! Want to collab on a track?",
    ...
    },
    {
      ...
      type: "TEXT",
      text: "Sure! Which track?",
      createdAt: "2026-03-14T17:15:00.000Z",
      status: "READ",
    },
    {
      id: "msg-2-3",
      ...
      receiverId: "mock-user-001",
      type: "TEXT",
      text: "Can you send the updated track?",
  ...
  "conv-uuid-3": [
    {
      ...
      receiverId: "mock-user-001",
      type: "TEXT",
      text: "Listened to Midnight Echoes — fire!",
    ...
    },
    {
      ...
      receiverId: "user-uuid-3",
      type: "TEXT",
      text: "Thanks! Which part did you like?",
...
app.get("/users/:userIdOrUsername", async (req, res) => {
  ...
  const user =
    USERS[param] || Object.values(USERS).find((u) => u.username === param);
...
app.post("/tracks", async (req, res) => {
  ...
  const newTrack = {
    ...
    plays: 0,
    isHD: false,
    isPrivate: req.body.privacy === "private",
    thumbnailUrl: null,
    userId: "mock-user-001",
  };
...
app.delete("/tracks/:id/like", async (req, res) => {
  ...
  const feedItem = feedItems.find((f) => f.track.id === req.params.id);
  if (feedItem) {
    feedItem.track.likesCount = Math.max(
      0,
      (feedItem.track.likesCount || 0) - 1,
    );
...
app.get("/feed", async (req, res) => {
  ...
  const fullItems = filtered.slice(start, end).map((item) => {
    ...
    return {
      ...
      numberOfReposts: item.track.repostsCount ?? fullTrack?.reposts ?? 0,
...
app.use((req, res) => {
  ...
  res
    .status(404)
    .json({ error: `Mock: no handler for ${req.method} ${req.url}` });
});
